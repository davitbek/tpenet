...
if (!function_exists('h')) {
    ...
    {
        return \LaraAreaSupport\Str::h($text, $double, $charset);
    }
}
...
if (!function_exists('create_slug')) {
    ...
    {
        return \LaraAreaSupport\Str::createSlug($str, $symbol);
    }
}
...
if (!function_exists('get_range')) {
    ...
    {
        return \LaraAreaSupport\Arr::range($min, $max, $step);
    }
}
...
if (!function_exists('first_key')) {
    ...
    {
        return \LaraAreaSupport\Arr::firstKey($array);
    }
}
...
if (!function_exists('last_key')) {
    ...
    {
        return \LaraAreaSupport\Arr::lastKey($array);
    }
}
...
if (!function_exists('array_unset')) {
    ...
    function array_unset(array $array, $values = [])
    {
        ...
        return \LaraAreaSupport\Arr::unset($array, $values);
    }
}
...
if (!function_exists('array_i_unique')) {
    ...
    {
        return \LaraAreaSupport\Arr::iUnique($array);
    }
}
...
if (!function_exists('in_array_i')) {
    ...
    {
        return \LaraAreaSupport\Arr::inArrayI($needle, $haystack);
    }
}
...
if (!function_exists('is_numeric_array')) {
    ...
    {
        return \LaraAreaSupport\Arr::isNumeric($array);
    }
}
